...
public class WebAppManagerIis(IOptions<IisConfig> iisConfig) : IWebAppManagerIis
{
    ...
    public bool StartWebApp()
    {
        ...
        if(site.State != ObjectState.Started)
            throw new InvalidOperationException($"The Web app '{_siteName}' could not be Started.");
    ...
    public bool StopWebApp()
    {
        ...
        if (site.State != ObjectState.Stopped)
        {
            ...
            if(site.State != ObjectState.Stopped)
                throw new InvalidOperationException($"The Web app '{_siteName}' could not be Stopped.");
        }
        ...
        if(applicationPool.State != ObjectState.Stopped)
            throw new InvalidOperationException($"The Application Pool '{_poolName}' could not be Stopped.");
